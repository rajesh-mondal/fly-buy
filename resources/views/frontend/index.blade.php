...
@section('content')
    ...
    <div class="banner">
        ...
        <div class="container fill_height">
            <div class="row fill_height">
                <div class="banner_product_image"><img src="{{ asset('files/product/'.$banner_product->thumbnail) }}" alt=" {{ $banner_product->name }} "></div>
                                ...
                                <div class="owl-item deals_item">
                                    ...
                                    <div class="deals_content">
                                        <div class="deals_info_line d-flex flex-row justify-content-start">
                                            <div class="deals_item_category"><a href="#">{{ $row->category->category_name }}</a>
                                            </div>
                                        ...
                                        <div class="deals_info_line d-flex flex-row justify-content-start">
                                            ...
                                            <div class="deals_item_price ml-auto">
                                                ...
                                                @else
                                                    <div class="trends_price discount">{{ $setting->currency }}{{ $row->discount_price }}</div>
                                                @endif
                                            </div>
                                        </div>
                                        <div class="available">
    ...
    @foreach ($home_category as $row)
        @php
            $cat_product = DB::table('products')->where('category_id', $row->id)->orderBy('id', 'DESC')->limit(12)->get();
        @endphp
                        ...
                        <div class="tabbed_container">
                            ...
                            <div class="row">
                                <div class="col-lg-9" style="z-index:1;">
                                    <!-- new arrival category product panel-->
                                    <div class="product_panel panel active">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 advert_col">
                    ...
                    <div class="advert d-flex flex-row align-items-center justify-content-start">
                        <div class="advert_content">
                            ...
                            <div class="advert_text">Best trendy product of this year for you.</div>
                        </div>
                        <div class="ml-auto">
                ...
                <div class="col-lg-4 advert_col">
                    ...
                    <div class="advert d-flex flex-row align-items-center justify-content-start">
                        <div class="advert_content">
                            <div class="advert_title"><a href="#">Trends 2023</a></div>
                            <div class="advert_text">Lorem ipsum dolor sit amet, consectetur.</div>
                        </div>
                        <div class="ml-auto">
                ...
                <div class="col-lg-3">
                    <div class="trends_container">
                        ...
                        <div class="trends_text">
                            <p>Best trendy product of this year for you.</p>
                        </div>
                        ...
                        <div class="owl-carousel owl-theme viewed_slider">
                            ...
                            <div class="owl-item">
                                <div class="viewed_item discount d-flex flex-column align-items-center justify-content-center text-center">
                                    <div class="viewed_image"><img src="{{ asset('files/product/'.$row->thumbnail) }}" alt="{{ $row->name }}">
                                    </div>
